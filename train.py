...
# 1. 数据预处理
# 训练集：随机翻转 + 随机旋转，增强数据多样性，减少过拟合
train_transform = transforms.Compose([
    transforms.Resize((128, 128)),  # 统一尺寸，加快 CPU 训练
...
# 2. 加载数据集
# 使用两个独立的 dataset，分别应用不同 transform
...
# 用同一组随机索引切分，保证 train_data/val_data 划分一致
